...
return [
    ...
    */
    ...
    'distinct'             => ':attributeにはそれぞれ異なる値を入れてください。',
    'email'                => ':attributeはメールアドレスを入力してください。',
    'filled'               => ':attributeは必須です。',
    'exists'               => '選択された:attributeは存在していません。',
    'file'                 => 'ファイルをアップロードしてください。',
    'image'                => ':attributeは画像にしてください。',
    'in'                   => ':attributeは:valuesのいずれかを入力してください。',
    'integer'              => ':attributeは整数にしてください。',
    'ip'                   => ':attributeを正しいIPアドレスにしてください。',
    'max'                  => [
        'numeric' => ':attributeは:max以下にしてください。',
        'file'    => 'アップロードするファイルは:max KB以下にしてください。',
    ...
    'require_if_not_exists' => '新規作成時は:attributeは必須です。',
    'unique_except_unchange' => ':attribute「:input」は既に存在します。',
    'EntryStatus' => ':attributeを変更する権限がありません。',
    'alreadyEntered' => '既にエントリーしています。',
    'userExists' => '既に登録されているユーザーです。',
    /*
    |--------------------------------------------------------------------------
